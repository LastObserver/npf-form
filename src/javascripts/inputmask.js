    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function renderColorMask(input, buffer, caretPos) {
            function handleStatic() {
                _static || null !== test.fn && void 0 !== testPos.input ? _static && null !== test.fn && void 0 !== testPos.input && (_static = !1, 
                maskTemplate += "</span>") : (_static = !0, maskTemplate += "<span class='im-static''>");
            }
            if (void 0 !== colorMask) {
